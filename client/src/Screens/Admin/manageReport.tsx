        ...
        <div className="insights">
          ...
          >
            ...
            <div className="middle">
              <div className="left">
                <h3>บล็อกที่ถูกรายงานทั้งหมด</h3>
                      ...
                      <tr key={report._id}>
                        ...
                        <td className="primary">
                          <Button
                            ...
                            style={{
                              opacity: report.status === "Pending" ? 1 : 0.5, // ✅ ทำให้ปุ่มซีดแทนการหายไป
                              cursor:
                                report.status === "Pending"
                                  ? "pointer"
                                  : "not-allowed",
            ...
            <table>
              ...
              {adminProfile && (
                <tbody>
                  {reports.length > 0 ? (
                    reports
                      .filter((report) => report.verified) // ✅ กรองเฉพาะบล็อกที่ตรวจสอบแล้ว
                      .map((report) => (
                        <tr key={report._id}>
                          <td>
                            {report.reportedBy
                          ...
                          >
                            {report.status === "Approved"
                              ? "อนุญาตให้อยู่บนเว็บไซต์"
                              : report.status === "Pending"
                              ? "รอดำเนินการ"
                              : report.status === "Cancel"
                              ? "ผู้ใช้ลบบล็อกหรือยกเลิกรายงาน"
                              : "ไม่อนุญาตให้อยู่บนเว็บไซต์"}
                          </td>
                          <td className="primary">
                            <Button
                              variant="info"
                    ...
                    <tr>
                      <td colSpan={5}>ไม่มีบล็อกที่ตรวจสอบแล้ว</td>
                    </tr>
                  )}
                </tbody>
              )}
